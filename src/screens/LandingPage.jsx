...
// ── NAV ────────────────────────────────────────────────────────
const DOWNLOAD_URL = "https://github.com/fourmeme21/sovereign-os-ui/releases/download/v0.6.7/sovereign-os_0.6.6_x64-setup.exe";
    ...
    <section ref={ref} className="section-reveal" id="problems" style={{ padding:"80px 24px" }}>
      <div style={{ maxWidth:1120, margin:"0 auto" }}>
        <div style={{ textAlign:"center", marginBottom:56 }}>
          ...
          <h2 style={{ fontFamily:"'Outfit',sans-serif", fontWeight:800, fontSize:"clamp(28px,3.5vw,44px)", color:T.textPrimary, letterSpacing:"-.01em", fontStyle:"normal" }}>
      ...
      <div style={{ maxWidth:600, margin:"0 auto", textAlign:"center", position:"relative", zIndex:1 }}>
        ...
        {state === "done" ? (
          <div style={{
            ...
            <div style={{ fontFamily:"'Outfit',sans-serif", fontWeight:700, fontSize:18, color:T.success, marginBottom:4, fontStyle:"normal" }}>
              You're on the list.
            </div>
